...
def compute_coherence(title, text):
...
def get_title_text(url):
  ...
  # List of function definied in the parsing script
  ...
  for function in bag_of_functions:
...
url_list = ['https://www.nytimes.com/2024/09/29/us/north-carolina-helene-relief-damage.html',
